...
# Use regex to replace the dashboard-mockup section
$pattern = '(?s)<div class="dashboard-mockup">.*?</div>\s*</div>\s*</div>'
$replacement = $newDashboard + "`r`n                </div>"
$content = $content -replace $pattern, $replacement

# Write back to file
[System.IO.File]::WriteAllText("$PWD\$filePath", $content, [System.Text.Encoding]::UTF8)
