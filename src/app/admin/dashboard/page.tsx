  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-wrap gap-6 items-start">
        <Card className="w-64" title="Delivery check-in" actions={<Button size='sm' variant='primary' onClick={()=>location.href='/admin/deliveries/new'}>Start</Button>}>
          <p className="text-xs text-[var(--sp-color-muted)]">Log material arrival quickly.</p>
        </Card>
        <Card className="w-64" title="New expense" actions={<Button size='sm' variant='primary' onClick={()=>location.href='/admin/expenses/new'}>Add</Button>}>
          <p className="text-xs text-[var(--sp-color-muted)]">Track cost against budget.</p>
        </Card>
        <Card className="w-64" title="Request change order" actions={<Button size='sm' variant='primary' onClick={()=>location.href='/admin/change-orders/new'}>Request</Button>}>
