...
export default function SettingsPageClient(){
  ...
  {tab==='org' && <form onSubmit={e=>{e.preventDefault(); /* TODO: handle success UI */}} className='space-y-4 max-w-xl'>
  ...
  {tab==='notifications' && <form onSubmit={e=>{e.preventDefault(); /* TODO: handle success UI */}} className='space-y-4 max-w-md'>
