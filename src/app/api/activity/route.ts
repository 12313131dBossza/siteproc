...
export async function GET(request: NextRequest) {
  try {
    ...
    const type = searchParams.get('type'); // delivery, expense, order, etc.
    const action = searchParams.get('action'); // created, updated, approved, etc.
    const status = searchParams.get('status'); // success, pending, failed, warning
