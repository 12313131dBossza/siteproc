-- Minimal Products Table Setup (No Dependencies)
-- This creates products table without any foreign key dependencies
-- Run this FIRST before orders-schema.sql

-- 1. Create products table without foreign key dependencies
...
-- 2. Create simple products RLS policies (anyone can read, authenticated can write)
...
select id, name, sku, price, stock, unit from public.products limit 5;
