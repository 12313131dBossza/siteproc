-- =====================================================
-- Phase 1F: Inventory Tracking Enhancement
-- =====================================================
...
ALTER TABLE products 
  ...
  ADD COLUMN IF NOT EXISTS stock_status TEXT DEFAULT 'in_stock' CHECK (stock_status IN ('in_stock', 'low_stock', 'out_of_stock', 'discontinued')),
